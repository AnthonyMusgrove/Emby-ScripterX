...
ScripterX now has a packages implementation.  See the [packages wiki page](https://github.com/AnthonyMusgrove/Emby-ScripterX/wiki/Packages) for more information.
