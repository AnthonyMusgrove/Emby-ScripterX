...
On Media Item Added | %item.name%, %item.id%, %item.type%, %item.path%, %item.originaltitle%, %item.tagline%, %item.overview%, %location.type%, %item.library.type%, %item.library.name%, %item.productionyear%, %item.meta.* (where *=provider, eg, %item.meta.imdb%), %episode.number%, %series.name%, %series.id%, %series.meta.*%, %season.id%, %season.number%, %season.name%, %season.meta.*%, %photo.album.name%, %photo.altitude%, %photo.longitude%,%photo.latitude%, %photo.aperture%, %photo.camera.make%, %photo.camera.model%, %photo.exposuretime%, %photo.focallength%, %photo.iso%, %photo.camera.model%, %photo.shutterspeed%, %photo.software%
On Media Item Updated | %item.name%, %item.id%, %item.type%, %item.path%, %item.originaltitle%, %item.tagline%, %item.overview%, %location.type%, %item.library.type%, %item.library.name%, %item.productionyear%, %item.meta.* (where *=provider, eg, %item.meta.imdb%), %item.update.reason%, %episode.number%, %series.name%, %series.id%, %series.meta.*%, %season.id%, %season.number%, %season.name%, %season.meta.*%, %photo.album.name%, %photo.altitude%, %photo.longitude%,%photo.latitude%, %photo.aperture%, %photo.camera.make%, %photo.camera.model%, %photo.exposuretime%, %photo.focallength%, %photo.iso%, %photo.camera.model%, %photo.shutterspeed%, %photo.software%
